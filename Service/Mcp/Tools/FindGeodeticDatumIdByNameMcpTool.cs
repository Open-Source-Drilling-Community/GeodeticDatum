...
internal sealed class FindGeodeticDatumIdByNameMcpTool : GeodeticDatumToolBase
{
    ...
    public override string Name => "geodetic_datum.find_id_by_name";

    public override string Description => "Look up a geodetic datum identifier by a case and whitespace insensitive name match.";
